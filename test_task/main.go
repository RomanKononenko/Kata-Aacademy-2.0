...
func calculate(expression string) string {
	...
	sum := strings.ContainsAny(expression, "+")
	subtract := strings.ContainsAny(expression, "-")
	multiply := strings.ContainsAny(expression, "*")
	divide := strings.ContainsAny(expression, "/")
	...
	if strings.ContainsAny(Gtokens[0], ArabicNumbers) {
